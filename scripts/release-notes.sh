...
#
# Usage: scripts/release-notes.sh v6.5.0   (the leading "v" is optional)
#
...
# Sections look like "## [6.5.0](https://.../compare/v6.4.0...v6.5.0) (date)".
...
# Everything between that heading and the next h2, minus the heading itself —
