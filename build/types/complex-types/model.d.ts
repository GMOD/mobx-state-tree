...
import { type FunctionWithFlag } from "../../core/action.ts";
import { type IJsonPatch } from "../../core/json-patch.ts";
import type { AnyNode } from "../../core/node/BaseNode.ts";
import { type IStateTreeNode } from "../../core/node/node-utils.ts";
...
import { type IAnyType, type Instance, type IType, TypeFlags } from "../../core/type/type.ts";
 ...
 * @hidden
 */
export declare class ModelType<PROPS extends ModelProperties, OTHERS, CustomC, CustomS, MT extends IModelType<PROPS, OTHERS, CustomC, CustomS>> extends ComplexType<ModelCreationType2<PROPS, CustomC>, ModelSnapshotType2<PROPS, CustomS>, ModelInstanceType<PROPS, OTHERS>> implements IModelType<PROPS, OTHERS, CustomC, CustomS> {
    ...
    private instantiateViews;
    preProcessSnapshot: MT["preProcessSnapshot"];
    postProcessSnapshot: MT["postProcessSnapshot"];
