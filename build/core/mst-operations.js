...
import { isModelType } from "../types/complex-types/model.js";
import { assertIsValidIdentifier, normalizeIdentifier } from "../types/utility-types/identifier-utils.js";
import { InvalidReferenceError } from "../types/utility-types/reference.js";
import { asArray, assertArg, assertIsFunction, assertIsNumber, assertIsString, EMPTY_OBJECT, fail, freeze } from "../utils.js";
import { getRunningActionContext } from "./actionContext.js";
import { splitJsonPath } from "./json-patch.js";
import { assertIsStateTreeNode, getRelativePathBetweenNodes, getStateTreeNode, isStateTreeNode, resolveNodeByPath } from "./node/node-utils.js";
import { assertIsType } from "./type/type.js";
/**
